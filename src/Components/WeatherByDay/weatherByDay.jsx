...
function WeatherByDay(props) {
  ...
  return (
        ...
        <div className="weather-day-item">
          <div className="weather-day-content">
            ...
            <div className="inner-content">
              ...
              <p className="desc">{data?.current?.uvi}</p>
            </div>
          </div>
        </div>
        <div className="weather-day-item">
	...
	"
              ...
              <p className="desc">{data?.current?.humidity} %</p>
            </div>
          </div>
        </div>
        <div className="weather-day-item">
          <div className="weather-day-content">
            ...
            <div className="inner-content">
              ...
              <p className="desc">{`${data?.current?.visibility / 1000} km`}</p>
            </div>
          </div>
        </div>
        <div className="weather-day-item">
          <div className="weather-day-content">
            ...
            <div className="inner-content">
              ...
              <p className="desc">{data?.current?.pressure} hPa</p>
            </div>
          </div>
        </div>
      </div>
